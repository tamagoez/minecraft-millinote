    ...
    return (
      <>
        ...
        <div className="bottom-24 right-0 fixed z-50">
          <label htmlFor="feedback-modal" className="btn bg-base-500 rounded-none rounded-l-lg modal-button opacity-80 hover:opacity-95"><MdFeedback /><div className="hidden sm:inline"><p className="px-1"/>{fbtitle}</div></label>
          <Feedback />
        </div>
